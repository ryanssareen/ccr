...
import { authFilePath, DEFAULT_ENDPOINT, GITHUB_LOGIN_REQUIRES_BROWSER_MESSAGE, runTerminalAuth, } from "./terminal.js";
...
async function typeAndSubmit(stdin, text) {
...
async function readAuth(homeDir) {
    return JSON.parse(await readFile(authFilePath(homeDir), "utf8"));
}
